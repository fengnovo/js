(function (root, factory) {
    ...
    var emptyNodeAt = VNode.bind(null, {
        style: {},
        class: {}
    }, []);
    var frag = document.createDocumentFragment();
    var emptyNode = VNode(undefined, {
        style: {},
        class: {}
    }, [], undefined);
    ...
    function updateChildren(parentElm, oldCh, newCh) {
        ...
        var oldStartPtr = 0,
            oldEndPtr = oldCh.length - 1;
        var newStartPtr = 0,
            newEndPtr = newCh.length - 1;
        var oldStartElm = oldCh[0],
            oldEndElm = oldCh[oldEndPtr];
        var newStartElm = newCh[0],
